...
import { HelpDetailModal, MapModal } from '../Helper/Modals/DisasterRiskModal';
              ...
              <div className='w-[90%] mx-auto' ref={dropdownRef}>
                ...
                {filtered?.map((data, index) => (
                  <div key={index}>
                    ...
                    {data.active && <> <div onClick={() => handleDetail({ ...data })} className=' cursor-pointer relative h-full w-full border-5 p-1 my-2 rounded-md '>
                      <div className='absolute inset-0 '>
                        <div className='absolute h-[50%] max-md:h-[45%] max-sm:h-[28%]  md:w-[37%] max-md:w-[48%] max-sm:w-[90%]  blur-[2px] bg-white rounded-tl-full  bottom-0 right-0 '></div>
                      ...
                      <div className='relative h-full w-full flex flex-col'>
                        <div key={''} className='relative h-full w-full max-sm:flex-col flex max-sm:items-center items-start justify-evenly max-sm:flex-wrap gap-2'>
                          ...
                          <div className='flex sm:gap-4 max-sm:gap-1 items-center justify-between flex-col md:px-1'>
                            <div className='flex sm:gap-2 max-sm:gap-2 items-center justify-between'>
            ...
            <div className='max-sm:hidden sticky top-0 h-screen flex flex-col items-center justify-evenly max-2xl:w-[28%] w-[28%]'>
              ...
              <div ref={imageDiv} className='mt-5 flex items-center justify-center h-1/2 w-fit'>
                <img
                  ...
                  alt="disaster image"
                  className='md:h-60 md:w-48 lg:h-72 lg:w-56 xl:h-80 xl:w-64 sm:h-56 sm:w-40 rounded-2xl'
                />
              </div>
